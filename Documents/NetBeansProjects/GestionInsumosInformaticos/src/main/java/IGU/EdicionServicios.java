...
public class EdicionServicios extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnAtras1.setIcon(new javax.swing.ImageIcon("C:\\Users\\Administrador\\Downloads\\edit (1).png")); // NOI18N
        ...
        btnDeleted.setIcon(new javax.swing.ImageIcon("C:\\Users\\Administrador\\Downloads\\delete.png")); // NOI18N
    ...
    private void btnAtras1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAtras1ActionPerformed
       if(jTable1.getSelectedRow()!=-1){
        ...
        EditarServicio editarServicio = new EditarServicio(id);
        editarServicio.setVisible(true);
        editarServicio.setLocationRelativeTo(this);
        this.dispose();
        }
    ...
    private void btnDeletedActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeletedActionPerformed
        if(jTable1.getSelectedRow()!=-1){
            ...
            controlLogica.eliminarServicio(id);
            mostrarMensaje("El item se elimino correctamente","Informacion","Completo");
            
            EdicionServicios edicionServi = new EdicionServicios();
            edicionServi.setVisible(true);
            edicionServi.setLocationRelativeTo(this);
            this.dispose();            
        }
    ...
    private void cargarTabla() {
        ...
        List <Servicio> listaServicios = controlLogica.buscarListaServicio();
