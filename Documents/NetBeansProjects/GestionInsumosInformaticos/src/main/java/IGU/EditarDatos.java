...
public class EditarDatos extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnServicios.setIcon(new javax.swing.ImageIcon("C:\\Users\\Administrador\\Downloads\\hospital (1).png")); // NOI18N
        btnServicios.setToolTipText("Tintas");
    ...
    private void btnCompuActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCompuActionPerformed
        EdicionComputadoras editarCompu = new EdicionComputadoras();
    ...
    private void btnHardwareActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnHardwareActionPerformed
        EdicionHardware editarHard = new EdicionHardware();
    ...
    private void btnTintaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTintaActionPerformed
        EdicionTintas editarTinta = new EdicionTintas();
    ...
    private void btnServiciosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnServiciosActionPerformed
        EdicionServicios editarServicio = new EdicionServicios();
